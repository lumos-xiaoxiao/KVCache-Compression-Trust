...
def main():
    ...
    base_dir = "/data/maxiaoxiao/security/DecodingTrust/results/machine_ethics/generations"
    result_list = []
    ...
    for dataset_name in DATASET_NAMES:
        ...
        for model_name in model_names:
            ...
            if check_all_scenarios(file_names) == True:
            ...
            for file_name in file_names:
                ...
                # print(file_name)
                # TODO:  delete '' or file_name.startswith("")
                ...
                # Zero-shot setting
                    ...
                    if "label" not in file_name :
                        file_path = os.path.join(dir_path, file_name)
                        new_file_name = file_name if file_name.startswith("label_") else "label_" + file_name
                        label_path = os.path.join(dir_path, new_file_name)
                    else :
                        label_path = os.path.join(dir_path, file_name)
                        new_file_name = file_name.replace("label_", "", 1) if file_name.startswith("label_") else file_name
                    ...
                    if model_name not in GPT_MODEL_NAMES:
                        # /data/maxiaoxiao/security/DecodingTrust/results/machine_ethics/generations/ethics_commonsense_short/hf/data/maxiaoxiao/security/model/Llama-2-7b-chat-hf/label_few_shot_0_test_num0_jailbreak_0_evasive_0.json
                        with open(label_path, "r") as f:
                            label_list = json.load(f)
