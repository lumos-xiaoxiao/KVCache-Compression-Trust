...
# from evaluate import load as load_metric  # 确保引入新库
...
def main(OPTS):
    ...
    with TemporaryDirectory(dir="./.cache") as dirname:
        ...
        # print(model.model_config)  # huggingface/Llama-2-7b-chat-hf 0x7f978f8f4dc0>
        # model # <dt.chat.HFChat object at 0x7f8c423b9160> 
        ...
        for task_name in tasks:  # , dataset in datasets.items():
            ...
            metric = load_metric("/data/maxiaoxiao/security/DecodingTrust/glue.py", task_name if task_name != 'mnli-mm' else 'mnli')
